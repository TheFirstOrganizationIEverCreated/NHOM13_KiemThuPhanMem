    ...
    private void ClickedRunButton (object sender, RoutedEventArgs e)
    {
        switch (SelectedExercise)
        {
            ...
            case Exercise.Exercise11:
                ...
                break;
            case Exercise.Exercise12:
                (new Exercise12()).ShowDialog();
                break;
            case Exercise.Exercise13:
                (new Exercise13()).ShowDialog();
                break;
            case Exercise.Exercise14:
                (new Exercise14()).ShowDialog();
                break;
            case Exercise.Exercise16:
                (new Exercise16()).ShowDialog();
                break;
            ...
            case Exercise.Exercise23:
                ...
                break;
            case Exercise.Exercise24:
                (new Exercise24()).ShowDialog();
                break;
            ...
            case Exercise.Exercise26:
                ...
                break;
            case Exercise.Exercise27:
                (new Exercise27()).ShowDialog();
                break;
