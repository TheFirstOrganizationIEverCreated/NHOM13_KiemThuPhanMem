...
public partial class Exercise20 : Window, INotifyPropertyChanged
{
    ...
    private void NotifyInvalidM () =>
        Notification = "m phải thuộc Z+ và m thuộc [5 ; 50]";
    ...
    private bool MIsValid () =>
        int.TryParse(MString, out var m) && (5 <= m) && (m <= 50);
